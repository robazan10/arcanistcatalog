  ...
  return (
    <div className="fixed bottom-6 right-5 z-50 flex flex-col gap-3">
      ...
      <a
        ...
        className="flex items-center justify-center w-12 h-12 rounded-full bg-green-500 hover:bg-green-400 shadow-lg transition-transform hover:scale-110 active:scale-95"
      >
        <WhatsAppIcon />
      </a>
    </div>
